...
po/$(PACKAGE_NAME).metainfo.pot: $(APPSTREAMFILE)
	xgettext --no-git --default-domain=$(PACKAGE_NAME) --output=$@ $<
...
$(DIST_TEST): $(NODE_MODULES_TEST) $(COCKPIT_REPO_STAMP) $(shell find src/ -type f) po/LINGUAS package.json build.js
